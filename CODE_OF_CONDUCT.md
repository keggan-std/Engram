...
We as members, contributors, and maintainers of the Engram project pledge to
...
Discussions, Pull Requests, code review comments, and any other forum where
Engram community members interact — and also applies when an individual is
...
reported to the project maintainers via a private GitHub message or by email
(contact details are on the maintainer's GitHub profile).
...
Maintainers will follow these guidelines when determining consequences for any
